  ...
  async deleteSession () {
    ...
    if (this.isSimulator() && !this.opts.noReset && !!this.opts.device) {
      ...
      if (this.lifecycleData.createSim) {
        ...
        log.debug(`Quitting and uninstalling WDA app (udid: '${this.opts.udid}')`);
        // We're not destroying the simulator, but we should still clean up after ourselves.
        await this.wda.quit();
        // Unfortunately `quit` is insufficient to actually stop the WDA server.
